...
public class RuleMergeTPAddBJVALUESAndRequestIntoOneRequest extends GenericRuleMergeTPAddAndRequestIntoOneRequest {

    public RuleMergeTPAddBJVALUESAndRequestIntoOneRequest( final double priority ) {
        super(priority);
    }
