...
public class LPG2RDF {
    ...
    public static final Resource PropertyMapping = resource("PropertyMapping");
    public static final Resource IRIBasedPropertyMapping = resource("IRIBasedPropertyMapping");
    ...
    public static final Property propertyMapping = property("propertyMapping");
