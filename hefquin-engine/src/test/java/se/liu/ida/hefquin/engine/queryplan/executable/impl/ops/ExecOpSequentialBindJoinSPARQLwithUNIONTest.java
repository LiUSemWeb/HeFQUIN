...
public class ExecOpSequentialBindJoinSPARQLwithUNIONTest extends TestsForTPAddAlgorithms<SPARQLEndpoint>
{
	@Test
	...
	protected UnaryExecutableOp createExecOpForTest( final TriplePattern tp,
		...
		return new ExecOpSequentialBindJoinSPARQLwithUNION( tp,
		                                          fm,
		                                          expectedVariables,
