...
public class RuleMergeTPAddBJFILTERAndBGPReqIntoOneRequest extends GenericRuleMergeTPAddAndRequestIntoOneRequest{

    public RuleMergeTPAddBJFILTERAndBGPReqIntoOneRequest( final double priority ) {
        super(priority);
    }
