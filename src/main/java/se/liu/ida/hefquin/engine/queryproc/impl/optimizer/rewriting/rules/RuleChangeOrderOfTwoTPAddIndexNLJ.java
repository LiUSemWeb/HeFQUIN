...
public class RuleChangeOrderOfTwoTPAddIndexNLJ extends AbstractRewritingRuleImpl{
    ...
    protected boolean canBeAppliedTo( final PhysicalPlan plan ) {
        ...
        return IdentifyPhysicalOpUsedForTPAdd.isIndexNLJ(rootOp) && IdentifyPhysicalOpUsedForTPAdd.isIndexNLJ(subRootOp);
    }
    ...
    protected RuleApplication createRuleApplication( final PhysicalPlan[] pathToTargetPlan ) {
        return new AbstractRuleApplicationImpl(pathToTargetPlan, this) {
            ...
            protected PhysicalPlan rewritePlan( final PhysicalPlan plan ) {
                ...
                final PhysicalPlan newSubPlan = PhysicalPlanFactory.createPlanWithBindJoin( rootLop , plan.getSubPlan(0).getSubPlan(0) );
                return PhysicalPlanFactory.createPlanWithBindJoin( subRootLop, newSubPlan );
            }
        };
    }
