...
public class RuleMergeJoinOfOneTPReqIntoTPAdd extends AbstractRewritingRuleImpl{
    ...
    protected boolean canBeAppliedTo( final PhysicalPlan plan ) {
        ...
        if ( rootOp.getLogicalOperator() instanceof LogicalOpJoin ) {
            ...
            return IdentifyPhysicalOpUsedForReq.isTriplePatternRequest( subPlanOp1 )
                    || IdentifyPhysicalOpUsedForReq.isTriplePatternRequest( subPlanOp2 );
        }
        return false;
    }
    ...
    protected RuleApplication createRuleApplication( final PhysicalPlan[] pathToTargetPlan ) {
        return new AbstractRuleApplicationImpl(pathToTargetPlan, this) {
            ...
            protected PhysicalPlan rewritePlan( final PhysicalPlan plan ) {
                ...
                if ( IdentifyPhysicalOpUsedForReq.isTriplePatternRequest( subPlan1.getRootOperator() ) ) {
                ...
                else if ( IdentifyPhysicalOpUsedForReq.isTriplePatternRequest( subPlan2.getRootOperator() ) ) {
