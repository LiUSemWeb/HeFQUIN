...
public class PhysicalOpGlobalToLocal implements UnaryPhysicalOpForLogicalOp
{
	...
	public UnaryExecutableOp createExecOp( final boolean collectExceptions,
		...
		return new ExecOpGlobalToLocal( lop.getVocabularyMapping(), collectExceptions, qpInfo, lop.mayReduce() );
	}
	...
	public static class Factory implements PhysicalOpFactory
	{
		...
		@Override
		public PhysicalOpGlobalToLocal create( final UnaryLogicalOp lop ) {
			if ( lop instanceof LogicalOpGlobalToLocal op ) {
				return new PhysicalOpGlobalToLocal(op);
			}
