...
public class RuleMergeTPAddBJVALUESAndBGPAddIndexNLJIntoBGPAdd extends GenericRuleMergeTPAddAndBGPAddIndexNLJIntoBGPAdd{

    public RuleMergeTPAddBJVALUESAndBGPAddIndexNLJIntoBGPAdd( final double priority ) {
        super(priority);
    }
