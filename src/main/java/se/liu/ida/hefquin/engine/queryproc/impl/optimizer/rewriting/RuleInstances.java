...
public class RuleInstances {
    ...
    public void addRuleInstances() {
        ...
        ruleApplications.add( new RuleConvertBGPAddToIndexNLJ(0.3) );
        ruleApplications.add( new RuleConvertBGPAddToBindJoin(0.3) );
        ruleApplications.add( new RuleConvertBGPAddToBJFILTER(0.3) );
        ruleApplications.add( new RuleConvertBGPAddToBJUNION(0.3) );
        ruleApplications.add( new RuleConvertBGPAddToBJVALUES(0.3) );
        ...
        // Group 2.5: divide one bgpAdd to multiple operators
