...
{if ("" != null) return new ElementNamedGraph(n, el) ;}
  ...
  final public Element ServiceGraphPattern() throws ParseException {Element el ; Node n ; boolean silent = false ; Var v ; String paramName ; java.util.Map<String,Var> paramVars = null ;
...
silent=true;
    ...
    case PARAMS:{
      ...
      jj_consume_token(LPAREN);
paramVars = new java.util.LinkedHashMap<>();
      v = Var();
      jj_consume_token(AS);
      paramName = String();
...
if ( paramVars == null )
        ...
        {if ("" != null) return new ElementServiceWithParams(n, el, silent, paramVars) ;}
    throw new Error("Missing return statement in function");
}
