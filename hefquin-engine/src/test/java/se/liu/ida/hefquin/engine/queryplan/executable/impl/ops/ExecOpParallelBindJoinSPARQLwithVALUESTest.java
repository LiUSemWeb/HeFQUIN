...
public class ExecOpParallelBindJoinSPARQLwithVALUESTest extends TestsForTPAddAlgorithms<SPARQLEndpoint>
{
	@Test
	...
	protected UnaryExecutableOp createExecOpForTest( final TriplePattern tp,
		...
		return new ExecOpParallelBindJoinSPARQLwithVALUES(
				tp, fm, expectedVariables, useOuterJoinSemantics, false,
