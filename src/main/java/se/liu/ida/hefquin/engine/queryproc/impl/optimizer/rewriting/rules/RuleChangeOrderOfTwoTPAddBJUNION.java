...
public class RuleChangeOrderOfTwoTPAddBJUNION extends AbstractRewritingRuleImpl{
    ...
    protected boolean canBeAppliedTo( final PhysicalPlan plan ) {
        ...
        return IdentifyPhysicalOpUsedForTPAdd.isBindJoinUNION(rootOp) && IdentifyPhysicalOpUsedForTPAdd.isBindJoinUNION(subRootOp);
    }
    ...
    protected RuleApplication createRuleApplication( final PhysicalPlan[] pathToTargetPlan ) {
        return new AbstractRuleApplicationImpl(pathToTargetPlan, this) {
            ...
            protected PhysicalPlan rewritePlan( final PhysicalPlan plan ) {
                ...
                final PhysicalPlan newSubPlan = PhysicalPlanFactory.createPlanWithBindJoinUNION( rootLop , plan.getSubPlan(0).getSubPlan(0) );
                return PhysicalPlanFactory.createPlanWithBindJoinUNION( subRootLop, newSubPlan );
            }
        };
    }
