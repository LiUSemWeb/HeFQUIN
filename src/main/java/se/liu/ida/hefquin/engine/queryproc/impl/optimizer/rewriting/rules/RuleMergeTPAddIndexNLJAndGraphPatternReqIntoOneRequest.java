...
public class RuleMergeTPAddIndexNLJAndGraphPatternReqIntoOneRequest extends GenericRuleMergeTPAddAndGraphPatternReqIntoOneRequest{

    public RuleMergeTPAddIndexNLJAndGraphPatternReqIntoOneRequest( final double priority ) {
        super(priority);
    }
