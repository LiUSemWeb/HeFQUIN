 ...
 */
public class FederationAccessManagerWithPersistedDiskCache implements FederationAccessManager
{
	...
	protected final CardinalityCacheMap<CardinalityCacheKey> cardinalityCache;
	...
	public CompletableFuture<CardinalityResponse> issueCardinalityRequest(final SPARQLRequest req, final SPARQLEndpoint fm)
			throws FederationAccessException 
	{
		final CardinalityCacheKey key = new CardinalityCacheKey(req.getQuery(), fm.getInterface().getURL());
