...
public class PropertyNameMappingImpl_AllToURIsTest {
    protected final String NSPROPERTY = "https://example.org/property/";

    protected final PropertyNameMapping propertyNameMapping = new PropertyNameMappingImpl_AllToURIs(NSPROPERTY);
