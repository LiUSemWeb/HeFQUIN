...
{
	protected static final LogicalOpUnion singletonWithoutReduction = new LogicalOpUnion(false);
	protected static final LogicalOpUnion singletonThatMayReduce  = new LogicalOpUnion(true);
